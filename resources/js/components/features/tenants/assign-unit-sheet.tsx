...
export default function AssignUnitSheet({
    ...
    useEffect(() => {
        if (!unitInitialized.current) {
            unitInitialized.current = true;
    ...
    function handleSubmit(e: React.FormEvent) {
        ...
        submit(tenants.assignUnit({ tenant: tenant!.id }), {
                        ...
                        <section>
                            ...
                            <div className="mt-3 grid gap-2">
                                ...
                                <SearchableSelect
                                    ...
                                    value={data.unit_id}
                                    onChange={(val) =>
                                        setData('unit_id', val as number | null)
                                    }
                                    placeholder={
                                        selectedPropertyId
                                            ? 'Select unit...'
